 ...
 */
class DeleteList implements HttpPostActionInterface
{
    /**
    ...
    public function execute(): Redirect
    {
        ...
        try {
            ...
            $this->messageManager->addErrorMessage(
                __('Something went wrong while deleting the list.')
            );
            return $resultRedirect->setPath(
                'customer/account/productlistview',
                ['list_id' => $listId]
        ...
        return $resultRedirect->setPath('customer/account/productlists');
    }
}
